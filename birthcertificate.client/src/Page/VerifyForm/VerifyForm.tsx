                ...
                <form className="mt-20" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    {/* Date of Registration and BR Number  */}
                     <div className="flex gap-10">
                        ...
                        <div className="relative z-0 w-full mb-5 group">
                            ...
                            type="text" 
                            id="BRNumber" 
                            defaultValue={BRInformation?.brNumber} 
                    ...
                    <div className="flex gap-10">
                        ...
                        <div className="relative z-0 w-full mb-5 group">
                            ...
                            type="text"
                            id="fathersBRN" 
                            defaultValue={BRInformation?.fathersBRN} 
                    ...
                    <div className="flex gap-10">
                        ...
                        <div className="relative z-0 w-full mb-5 group">
                            ...
                            type="text" 
                            id="fathersNID" 
                            defaultValue={BRInformation?.fathersNID} 
                    ...
                    <div className="flex gap-10 mt-14">
                        ...
                        <div className="relative z-0 w-full mb-5 group">
                            ...
                            type="text"
                            id="mothersBRN" 
                            defaultValue={BRInformation?.mothersBRN} 
                    ...
                    <div className="flex gap-10">
                        ...
                        <div className="relative z-0 w-full mb-5 group">
                            ...
                            type="text" 
                            id="motherNID" 
                            defaultValue={BRInformation?.mothersNID} 

                            {...register("mothersNID", {required: "Mother's NID is required", pattern: {value: /^\d{10}(\d{3})?$/, message: "Enter a valid NID Number"}})}
