...
namespace BirthCertificate.Server.Controllers
{
    ...
    public class BirthCertificateController : ControllerBase
    {
        ...
        [HttpPut]
        public ActionResult PostImageData([FromBody] BirthCertificateData BRInfoEn)
        {
            ...
            try
            {
                ...
                var BRInfoBn = operation.TranslateDataEnToBn(BRInfoEn);
                ...
                command.Parameters.AddWithValue("p_base64Image", BRInfoEn.base64Image);
                //english data
                ...
                return Ok(new {BRInfoEn, BRInfoBn });
            }
            catch (Exception ex)
            {
